	...
	<div class="price_slider_wrapper">
		...
		<div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">	
			...
			<div class="price_label" style="display:none;">
				<?php echo esc_html__( 'Від:', 'woocommerce' ); ?> <span class="from"></span> <?php echo esc_html__( 'До:', 'woocommerce' ); ?> <span class="to"></span>
			</div>
		...
		<button type="submit" class="button custom-number__button"><?php echo pll__( 'Застосувати', 'woocommerce' ); ?></button>
