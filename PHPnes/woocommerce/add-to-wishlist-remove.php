...
<div class="yith-wcwl-add-button">
	...
	<?php if( $show_view ): ?>
		...
		<a href="<?php echo esc_url( $found_in_list->get_url() ); ?>" class="view-wishlist"><?php echo esc_html( apply_filters( 'yith_wcwl_view_wishlist_label', __( 'Добавлено', 'yith-woocommerce-wishlist' ) ) ); ?></a>
	<?php endif; ?>
</div>
