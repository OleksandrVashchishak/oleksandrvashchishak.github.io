	...
	<li class="yith-wfbt-item">
		<label for="offeringID_<?php echo esc_attr( $index ); ?>">
			...
			<span class="product-name">
				<?php echo ! $index ? esc_html__( 'Поточний продукт', 'yith-woocommerce-frequently-bought-together' ) . ': ' . esc_html( $current_product_title ) : esc_html( $current_product_title ); ?>
			</span>
...
<section class="frequently">
	<div class="yith-wfbt-section woocommerce">
		<?php if ( $title != '' ) {
			echo '<h3 class="related__title">' . esc_html( $title ) . '</h3>';
		}
		?>
		...
		<form class="yith-wfbt-form" method="post" action="<?php echo esc_url( $url ) ?>">
			...
			<div class="yith-wfbt-submit-block">
				...
				<button type="submit" class="yith-wfbt-submit-button buy button">
