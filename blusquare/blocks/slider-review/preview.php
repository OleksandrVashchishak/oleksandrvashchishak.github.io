<section class="review-slider container">
    ...
    <div class="review-slider__slider">
        ...
        ?>
                <div class="review-slider__item">
                    <p class="review-slider__text">“ <?php block_sub_field('text-review'); ?> </p>
    ...
    <a href="<?php block_field('button-link'); ?>" class="main-btn review-slider__link"><?php block_field('button-text'); ?></a>
</section>