<section class="product-block container" id="products">
    <h3 class="product-block__main-title main-title"><?php block_field('title') ?></h3>
    <p class="product-block__main-subtitle main-subtitle"><?php block_field('text') ?> </p>

    <p class="product-block__main-top-text">
