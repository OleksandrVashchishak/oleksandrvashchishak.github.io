...
$(document).ready(function () {
  ...
  function getClosePopap() {
   ...
   let backButtonForm0 =   document.querySelectorAll('.closeW')[0];
   let backButtonForm1 =  document.querySelectorAll('.closeW')[1];
   let backButtonForm2 =  document.querySelectorAll('.closeW')[2];
   let backButtonForm3 =  document.querySelectorAll('.closeW')[3];
   let backButtonForm4 =  document.querySelectorAll('.closeW')[4];
   let backButtonForm5 =  document.querySelectorAll('.closeW')[5];
   let backButtonForm6 =  document.querySelectorAll('.closeW')[6];
  backButtonForm0.addEventListener("click", getCloseForm);
  backButtonForm1.addEventListener("click", getCloseForm);
  backButtonForm2.addEventListener("click", getCloseForm);
  backButtonForm3.addEventListener("click", getCloseForm);
  backButtonForm4.addEventListener("click", getCloseForm);
  backButtonForm5.addEventListener("click", getCloseForm);
  backButtonForm6.addEventListener("click", getCloseForm);
