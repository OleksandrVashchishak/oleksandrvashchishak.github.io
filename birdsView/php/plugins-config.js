let nextBtnSliderTranslate = document.querySelector('.next-btn-translate')
let prevBtnSliderTranslate = document.querySelector('.prev-btn-translate')
if(document.querySelector('.blog__pag-arrow-next')){
document.querySelector('.blog__pag-arrow-next').textContent = nextBtnSliderTranslate.textContent
document.querySelector('.blog__pag-arrow-prev').textContent = prevBtnSliderTranslate.textContent
}
...
if (document.querySelector(".two-block__slider")) {
  $(".two-block__slider").slick({
    ...
    arrows: true,
    focusOnSelect: false,
    prevArrow: '<div class="slick-prev slick-arrow">'+ prevBtnSliderTranslate.textContent + '</div>',
  nextArrow: '<div class="slick-next slick-arrow">'+ nextBtnSliderTranslate.textContent + '</div>',
  });
...
// start slider blog line
if(document.querySelector('.slider-blog__slider')){
// variables
let nextArrow = document.querySelector('.slick-next.slick-arrow')
let prevArrow = document.querySelector('.slick-prev.slick-arrow')
let blogSlider = document.querySelector('.slider-blog__slider')

// create line and add to DOM
let sliderLine = document.createElement("div");
sliderLine.classList.add('sliderLine--js-blog')
blogSlider.appendChild(sliderLine)

// line styles
sliderLine.style.left = prevArrow.offsetWidth + 10 + 'px'
sliderLine.style.right = nextArrow.offsetWidth + 10 + 'px'
}
// end slider blog line

// start services blog line
if (document.querySelector(".services-slider")) {
  // variables
  let nextArrow = document.querySelector(".slick-next.slick-arrow");
  let prevArrow = document.querySelector(".slick-prev.slick-arrow");
  let slider = document.querySelector(".services-slider__slider");
  let container = document.querySelector(".container");

  // create line and add to DOM
  let sliderLine = document.createElement("div");
  sliderLine.classList.add("sliderLine--js-services");
  slider.appendChild(sliderLine);

  // line styles
  sliderLine.style.left = prevArrow.offsetWidth + 10 + "px";
  sliderLine.style.width =
    nextArrow.offsetLeft - prevArrow.offsetWidth - 30 + "px";
}
// end services blog line