...
$(document).ready(function () {
  ...
  //  let backButtonForm = document.querySelectorAll('.closeW');
  //  for(i=0; i < backButtonForm.length;i++ ){
  //    console.log(document.querySelectorAll('.closeW')[i]);
  //    console.log(1212[i])
  //  }
  // console.log(backButtonForm)
  // backButtonForm.addEventListener("click", getCloseForm);
