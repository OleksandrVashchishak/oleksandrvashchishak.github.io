...
if (document.querySelector('.contact__input')) {
    ...
    input.forEach(input => {
        input.addEventListener('focus', () => {
            input.parentElement.querySelector('.contact__input-place').classList.add('active')
        })
        input.addEventListener('blur', () => {
            input.parentElement.querySelector('.contact__input-place').classList.remove('active')
        })
    })
}
// end form focus
